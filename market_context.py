...
class MarketContext:
    ...
    def get_trading_session(current_time=None):
        ...
        # Use the passed-in time for analysis, or live time if it's not provided.
        now = current_time or datetime.now(timezone.utc)
        hour = now.hour
        
        sessions = [
            (12, 16, 'LONDON_NY_OVERLAP', 1.3, 'Peak Volatility'),
            (9, 12, 'LONDON_MAIN', 1.1, 'Medium Volatility'),
            (7, 9, 'LONDON_OPEN', 1.2, 'High Volatility'),
            (16, 20, 'NY_MAIN', 1.0, 'Medium Volatility'),
            (0, 7, 'ASIAN_SESSION', 0.8, 'Low Volatility'),
            (21, 24, 'SYDNEY_SESSION', 0.7, 'Very Low Volatility'),
            (20, 21, 'NY_CLOSE', 0.6, 'Very Low Volatility')
        ]
